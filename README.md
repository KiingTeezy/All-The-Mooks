<p align="center"><img src="branding/logo.png" width="340" alt="All The Better Mooks"></p>

<h1 align="center">All The Better Mooks</h1>
...
<p align="center"><b>Server:</b> <code>mooksvill.datho.st</code></p>
...
2. In Prism: **Add Instance** -> **Import** -> paste the pack link from the
   **[latest release](https://github.com/KiingTeezy/All-The-Mooks/releases/latest)** -> **OK**.
   Prism downloads the pack and all 301 mods by itself.
...
**The base - All the Mods 11 (0.8.0-beta).** The full ATM11 experience: tech, magic, storage, quests, the ATM Star.

**The exploration layer - taken from Better MC 6:**
...
**Looks:** Fresh Animations and 10 shader packs (Complementary, BSL, Bliss, Lux, MakeUp, Sildur's and more).

**Runs smoother:** Structure Layout Optimizer, Sparse Structures (structures spread a little further apart), Entity Culling, Dynamic FPS.
...
- Every mod author whose work is in here - all mods belong to their creators.
